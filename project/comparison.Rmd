...
(whereas the ANN is fully connected in all layers) and pools layers to streamline
any underlying computation.
...
In comparison to the usage of logistic regression which is analogous
...
Similarly, algorithms for cluster analysis could also work but it relies more
